  ...
  return (
    <Card style={styles.cardStyle} mode={item.status === "inprogress" ? "elevated" : "contained"}>
        ...
        <Card.Content style={styles.content}>
            <Title><Text style={{fontWeight: "bold", textTransform: "uppercase"}}>Delivery:</Text> {item.bookingType}</Title>
    ...
    return (
      <PaperProvider>
        <SafeAreaView style={styles.container}>
          <View style={{ flexDirection: "row", justifyContent: "space-between", backgroundColor: primaryColor, paddingBottom: 20 }}>
            <Text  
              style={{fontWeight: "bold", fontSize: 22, marginHorizontal: 15, marginTop: 29, color: "white"}}
            >
              Booking's History
            </Text>
            <TouchableOpacity onPress={() => setIsActiveFilter(!isActiveFilter)} style={{ marginHorizontal: 15, marginTop: 14}} >
